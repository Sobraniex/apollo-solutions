...
- Provider terms appear as a one-card-at-a-time carousel. Expandable case records summarize the Anthropic book-copy rulings and settlement, Italy’s annulled OpenAI fine, a temporary OpenAI litigation hold on logs, and Italy’s DeepSeek regulatory action. Each record links to the underlying court or regulator document and separates findings, settlements, and disputed statements.
